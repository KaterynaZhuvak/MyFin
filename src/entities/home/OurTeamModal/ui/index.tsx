...
export const OurTeamModal: FC<OurTeamModalProps> = ({ isOpen, setIsOpen }) => {
  return (
    <CustomModal
      ...
      className='h-[600px] w-[300px] overflow-hidden rounded-[20px] bg-modal-background px-[50px] py-[30px] outline-none tablet:h-[800px] tablet:w-[600px] tablet:px-[100px] tablet:py-[60px]'
    >
      <Icon
        name='close'
        onClick={() => {
